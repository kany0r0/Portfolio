  ...
  return (
    <Layout>
      <div className="text-center md:text-left mt-6 md:mt-0">
        <div>
          <h2 className="font-display font-semibold text-4xl md:text-11xl leading-none tracking-tight">
            KenethKaranja
          </h2>
        </div>
        ...
        <div className="flex flex-row items-center justify-center md:justify-start mt-8 font-body font-light text-xs tracking-wide uppercase">
